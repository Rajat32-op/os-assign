...
- `ticks[4]` — ticks consumed at each level (cumulative)
- `times_scheduled` — how many times the scheduler has picked this process
- `total_syscalls` — total syscalls made (from PA1 counter)
...
```
t=10  CPU: lv=2 ticks=[2,4,4,0] sched=3  SYS: lv=0 ticks=[1,0,0,0] sched=10
t=20  CPU: lv=3 ticks=[2,4,8,6] sched=4  SYS: lv=0 ticks=[6,0,0,0] sched=18
t=30  CPU: lv=3 ticks=[2,4,8,16] sched=4  SYS: lv=0 ticks=[8,0,0,0] sched=27
t=40  CPU: lv=3 ticks=[2,4,8,26] sched=5  SYS: lv=0 ticks=[11,0,0,0] sched=35
...
t=100  CPU: lv=2 ticks=[4,8,10,78] sched=10  SYS: lv=0 ticks=[23,0,0,0] sched=89
t=110  CPU: lv=3 ticks=[4,8,16,82] sched=11  SYS: lv=0 ticks=[26,0,0,0] sched=97
t=120  CPU: lv=3 ticks=[4,8,16,92] sched=11  SYS: lv=0 ticks=[31,0,0,0] sched=105
```
...
- **Global boost at t=128**: the CPU child's level resets to 0. It immediately starts demoting again, as expected — the boost is a temporary reprieve, not a permanent fix. Since higher levels have small quantums, it quickly goes down to lower levels again. But we can see the time for which CPU process ran in level 0 and 1 increased.
